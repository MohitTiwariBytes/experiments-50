...
import "./Experiment03.css";
import LiquidAscii from "../../../Components/LiquidDistort/LiquidDistort";
...
export default function Experiment03() {
  ...
  return (
    <div className="main-experiment three">
      ...
      <LiquidAscii backgroundColor="transparent"></LiquidAscii>
    </div>
  );
}
